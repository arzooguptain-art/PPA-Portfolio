---
title: "Midterm Project: Predicted Model for Home Sales Price"
...
Converting predictions back from log scale to dollars provides a more intuitive assessment of model accuracy. The median absolute error is **\$42,994** against a median sale price of **\$232,258**. Mean absolute error of **\$60,818** is pulled upward by a small number of properties the model predicts poorly. This places our model in the acceptable range for an automated valuation model, while highlighting clear opportunities for improvement.
